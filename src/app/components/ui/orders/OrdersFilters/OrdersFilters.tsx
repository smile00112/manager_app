...
import { Checkbox, CheckBoxList, RangeSliderField } from '../../../common/Fields';
// import GuestsCounter from '../../GuestsCounter/GuestsCounter';
import OrdersFilterList from './OrdersFiltersList/OrdersFiltersList';
...
const OrdersFilter: React.FC<OrdersFilterProps> = ({ onReset }) => {
  ...
  return (
    <section className='filters__wrapper'>
      ...
      <OrdersFilterList data={data} handleChange={handleChangeFilter}>
